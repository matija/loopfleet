> **Archived 2026-07-12.** This is the v1 build PRD (M0–M7): backend + first React
> frontend, all shipped. Superseded by the active plan in `PRD.md` at repo root
> (Workbench UI). Kept for reference; not parsed as a live plan.
